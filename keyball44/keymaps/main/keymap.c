...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_universal(
    ...
    OM_LSFT  , KC_Z    , KC_X      , KC_C     , KC_V     , KC_B     ,           KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , OM_RSFT ,
               _______  , KC_DEL   , OM_LGUI  , KC_SPC   , OM_LCTL  ,           LT(_FUN, KC_TAB) , LT(_SYM, KC_SPC) , _______  , _______  , KC_APP
   ),
  ...
  [_SYM] = LAYOUT_universal(
    ...
    _______  , KC_BSLS  , KC_UNDS  , KC_HASH  , KC_ASTR  , KC_PLUS  ,           KC_PERC  , KC_AMPR  , _______  , _______  , _______  , _______  ,
               _______  , _______  , _______  , _______  , _______  ,           _______  , _______  , _______  , _______  , _______
  ),

  [_FUN] = LAYOUT_universal(
    _______  , KC_F1    , KC_F2    , KC_F3    , KC_F4    , KC_F5    ,           KC_F6    , KC_F7    , KC_F8    , KC_F9    , KC_F10   , _______  ,
    _______  , _______  ,G(S(KC_S)), KC_BRK   , KC_INS   , KC_F11   ,           KC_BRIU  , KC_APP   , KC_VOLU  , _______  , _______  , _______  ,
    _______  , KC_JIS   , KC_SCRL  , _______  , _______  , KC_F12   ,           _______  , _______  , _______  , _______  , _______  , _______  ,
               _______  , _______  , _______  , _______  , _______  ,           _______  , _______  , _______  , _______  , _______
  ),
