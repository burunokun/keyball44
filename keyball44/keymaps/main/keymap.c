...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_universal(
    ...
    OM_LSFT  , KC_Z    , KC_X      , KC_C     , KC_V     , KC_B     ,  KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , OM_RSFT  ,
               _______ , KC_ESC    , OM_LGUI  , KC_SPC   , OM_LCTL  ,  L_FUN    , L_SYM    , _______  , _______  , KC_DEL
   ),
  ...
  [_SYM] = LAYOUT_universal(
    ...
    _______  , KC_BSLS  , KC_UNDS  , KC_HASH  , KC_ASTR  , KC_PERC  ,  KC_PIPE  , KC_AMPR  , _______  , _______  , _______  , _______  ,
               _______  , _______  , _______  , _______  , _______  ,A(C(KC_TAB)),KC_SPC   , _______  , _______  , _______

    // _______  , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     ,  KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , _______  ,
    // _______  , KC_TILD  , KC_MINS  , KC_EXLM  , KC_QUOT  , KC_EQL   ,  KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , _______  , _______  ,
    // _______  , KC_BSLS  , KC_UNDS  , KC_HASH  , KC_ASTR  , KC_PERC  ,  KC_HOME  , KC_PGDN  , KC_PGUP  , KC_END   , _______  , _______  ,
    //            _______  , _______  , _______  , _______  , _______  ,A(C(KC_TAB)),KC_SPC   , _______  , _______  , _______
  ),
  ...
  [_FUN] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , KC_F12   ,  KC_BRIU  , KC_GRV   , KC_BRK   , KC_SCRL  , _______  , _______  ,
               _______  , _______  , _______  , _______  , _______  ,A(C(KC_TAB)),KC_SPC   , _______  , _______  , _______
  ),
