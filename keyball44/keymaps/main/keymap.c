...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_universal(
    ...
    OM_LSFT  , KC_Z    , KC_X      , KC_C     , KC_V     , KC_B     ,  KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , OM_RSFT  ,
               KC_COMM , KC_DOT    , OM_LGUI  , KC_SPC   , OM_LCTL  ,  LT(_FUN, KC_TAB)    , L_SYM    , _______  , _______  , KC_APP
   ),
  ...
  [_SYM] = LAYOUT_universal(
    ...
    _______  , KC_BSLS  , KC_UNDS  , KC_HASH  , KC_ASTR  , KC_AT    ,  KC_HOME  , KC_PGDN  , KC_PGUP  , KC_END   , _______  , _______  ,
               _______  , _______  , _______  , _______  , _______  ,  _______  , KC_SPC   , _______  , _______  , _______
  ),

  [_FUN] = LAYOUT_universal(
    _______  , KC_F1    , KC_F2    , KC_F3    , KC_F4    , KC_F5    ,  KC_F6    , KC_F7    , KC_F8    , KC_F9    , KC_F10   , _______  ,
    _______  , KC_BRIU  , KC_PSCR  , KC_VOLU  , G(KC_F)  , KC_F11   ,  KC_SCRL  , KC_DEL   , KC_BRK   , KC_BRK   , _______  , _______  ,
    _______  , KC_JIS   , KC_INT5  , KC_INT4  , KC_INT2  , KC_F12   ,C(G(KC_LEFT)),C(KC_PGUP),C(KC_PGDN),C(G(KC_RGHT)),_______,_______ ,
               _______  , _______  , _______  , _______  , _______  ,  _______  , KC_SPC   , _______  , _______  , _______
  ),
